...
## Technologies Used
- [**Microsoft .NET Framework**](https://dotnet.microsoft.com/en-us/download/dotnet-framework): Application framework for building Windows desktop apps and services. (Version: 4.8)
